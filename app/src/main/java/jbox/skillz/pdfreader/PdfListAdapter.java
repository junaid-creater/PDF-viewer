...
public class PdfListAdapter extends ArrayAdapter<DocsFile> {
    ...
    public PdfListAdapter(@NonNull MainActivity pdfDocument, int custom_layout, ArrayList<DocsFile> docsFiles,  ArrayList<File> myDocs) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView fileImage = convertView.findViewById(R.id.file_img);
        final ImageView fileOptions = convertView.findViewById(R.id.file_options);
